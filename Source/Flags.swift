...
public extension Regex
{
    public struct Flags: OptionSetType
    {
        ...
        static let IgnoreCase = Flags(rawValue: REG_ICASE)
        
        /// Use POSIX Extended Regular Expression syntax.
        static let Extended = Flags(rawValue: REG_EXTENDED)
        ...
        static let Newline = Flags(rawValue: REG_NEWLINE)
        
        /// Do not report position of matches.
        static let NoRanges = Flags(rawValue: REG_NOSUB)
    }
}
